...
- Pairs with **deep-bible-study-devotional** if the leader wants the full chapter walk first, then the discussion packet.
- Pairs with **chapter-readme-fill** if the shared chapter README's Questions section needs better questions — the discussion packet's Application questions can seed that.
