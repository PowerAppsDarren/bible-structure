...
- Pairs with **group-discussion-prep** when a leader wants to surface group take-aways before the next meeting.
- Pairs with **topic-trace** when group divergence on a theme suggests the theme deserves a shared topic page.
