...
- Pairs with **personal-reflection** when the user wants both reflection and prayer in one journal entry.
- Pairs with **deep-bible-study-devotional** when the user wants the prayer as the closing section of a fuller chapter walk.
