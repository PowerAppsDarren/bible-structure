...
- Pairs with **character-study** for figures defined by location (Jonah → Nineveh; Jesus' Galilee ministry).
- Pairs with **chapter-readme-fill** when geography illuminates a chapter passage.
